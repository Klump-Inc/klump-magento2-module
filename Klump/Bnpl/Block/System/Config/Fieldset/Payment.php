...
namespace Klump\Bnpl\Block\System\Config\Fieldset;

use Magento\Framework\Data\Form\Element\AbstractElement;

/**
 * Fieldset renderer for Klump BNPL payment
 */
class Payment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
  ...
  protected function _getFrontendClass($element)
  {
   ...
   /**
   * Return header title part of html for Klump BNPL payments
   *
   * @param AbstractElement $element
   * @return string
  ...
  protected function _getHeaderTitleHtml($element)
  {
    ...
    $heading_style = "";
    $html .= '<div class="button-container admin__collapsible-block klump-block">'.
  ...
  /**
   * Return header comment part of html for Klump BNPL payments
   *
   * @param AbstractElement $element
   * @return string
